...
our $Options = {
    ...
    'infill_extruder' => {
        ...
        tooltip => '[infill_extruder] : Extrudeur à utiliser pour le remplissage.',
        cli     => 'infill-extruder=i',
        type    => 'i',
        default => 1,
    },
    'support_material_extruder' => {
        label   => 'Extrudeur pour le support matériel',
    ...
    'first_layer_bed_temperature' => {
        label   => 'Premier calque',
        tooltip => '[first_layer_bed_temperature] : Température de la platine chauffante pour le premier calque. Réglez ce paramètre à zéro pour désactiver le contrôle de température de la platine dans les commandes de sortie.',
        sidetext => '°C',
    ...
    'bed_temperature' => {
        label   => 'Autres calques',
        tooltip => '[bed_temperature] : Température de la platine chauffante pour les autres calques. Réglez ce paramètre à zéro pour désactiver le contrôle de température de la platine dans les commandes de sortie.',
        sidetext => '°C',
    ...
    'travel_speed' => {
        label   => 'Déplacement',
        tooltip => '[travel_speed] : Vitesse pour les déplacements (sauts entre deux points d\'extrusion distants).',
        sidetext => 'mm/s',
        cli     => 'travel-speed=f',
        type    => 'f',
    ...
    'perimeter_speed' => {
        label   => 'Périmètres',
        tooltip => '[perimeter_speed] : Vitesse pour les perimètres (contours, aka parois verticales).',
        sidetext => 'mm/s',
    ...
    'small_perimeter_speed' => {
        label   => 'Petits périmètres',
        tooltip => '[small_perimeter_speed] : Ce réglage séparé affecte la vitesse des périmètres dont le diamètre est inférieur ou égal à 6.5mm (en général les trous). S\'il est exprimé en pourcentage (par exemple 80%), il sera calculé par rapport à la vitesse des périmètres réglée ci-dessus.',
        sidetext => 'mm/s ou %',
    ...
    'external_perimeter_speed' => {
        label   => 'Périmètres extérieurs',
        tooltip => '[external_perimeter_speed] : Ce réglage séparé affecte la vitesse des périmètres extérieurs (ceux qui sont visibles). S\'il est exprimé en pourcentage (par exemple 80%), il sera calculé par rapport à la vitesse des périmètres réglée ci-dessus.',
        sidetext => 'mm/s ou %',
    ...
    'infill_speed' => {
        label   => 'Remplissage',
        tooltip => '[infill_speed] : Vitesse pour l\'impression du remplissage intérieur.',
        sidetext => 'mm/s',
        cli     => 'infill-speed=f',
        type    => 'f',
    ...
    'solid_infill_speed' => {
        ...
        tooltip => '[solid_infill_speed] : Vitesse pour l\'impression des zones solides (dessus/dessous/parrois horizontales internes). Peut-être exprimé en pourcentage (ex. 80%) de la vistesse de remplisage réglée ci-dessus.',
        sidetext => 'mm/s ou %',
    ...
    'top_solid_infill_speed' => {
        label   => 'Remplissage solide en haut',
        tooltip => '[top_solid_infill_speed] : Vitesse pour l\'impression des zones solides en haut de la pièce. Vous pouvez vouloir ralentir cette valeur pour avoir une meilleure finition de surface.Peut-être exprimé en pourcentage (ex. 80%) de la vistesse de remplisage réglée ci-dessus.',
        sidetext => 'mm/s or %',
